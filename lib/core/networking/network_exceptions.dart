import 'dart:io';
import 'package:clean_architecture_app/core/networking/api_error_model.dart';
...
abstract class NetworkExceptions with _$NetworkExceptions {
  ...
  static NetworkExceptions handleResponse(Response? response) {
    ApiErrorModel errorEntity =
        ApiErrorModel.fromJson(response?.data);
    String errorString = "${errorEntity.success} : ${errorEntity.statusMessage}";
